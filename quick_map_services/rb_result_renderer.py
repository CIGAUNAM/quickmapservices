...
from qgis.core import Qgis, QgsRectangle, QgsCoordinateReferenceSystem, QgsCoordinateTransform, QgsPoint, QgsProject, QgsWkbTypes
...
class RubberBandResultRenderer():
    ...
    def __init__(self):
        ...
        self.transformation = QgsCoordinateTransform(QgsCoordinateReferenceSystem("EPSG:4326"), QgsCoordinateReferenceSystem("EPSG:4326"), QgsProject.instance())
